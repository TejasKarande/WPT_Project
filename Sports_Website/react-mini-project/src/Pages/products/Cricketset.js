...
import cricketset from "./images-of-products/cricketset.jpg";
    ...
    <>
      ...
      <div className="container">
        <div className="row mt-5">
          ...
          <div className="col-12 col-md-10 col-lg-6">
            <div className="mt-5">
              <h2>SG Economy Cricket Kit-Full Kit</h2>
            </div>
            <p className="mb-5">Brand: SG</p>
            <h3 className="mb-3">₹ 6,500</h3>
            <div className="mb-3">
