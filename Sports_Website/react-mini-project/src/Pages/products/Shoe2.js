...
import shoe2 from "./images-of-products/shoe-2.jpg";
      ...
      <div className="container">
        <div className="row mt-5">
          ...
          <div className="col-12 col-md-10 col-lg-6">
            <div className="mt-5">
              <h2>Nike Lebron Witness VIi Running Shoe</h2>
            </div>
            <p className="mb-5">Brand: Nike</p>
            <h3 className="mb-3">₹ 6000</h3>
            <div className="mb-3">
            ...
            <ul>
              <li>Textile upper</li>
              <li className="mt-1">Cushioned footbed</li>
              <li className="mt-1">
                Mesh throughout the vamp is breathable and stretchy{" "}
              </li>
              <li className="mt-1">Moulded details around the collar</li>
            </ul>
          </div>
        </div>
            ...
            <div className="reviews mt-4 mb-5">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">Good Product , Good Quality</p>
                </div>
              </div>
            </div>
          </div>
