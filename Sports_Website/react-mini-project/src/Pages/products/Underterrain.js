...
import underterrain from "./images-of-products/underterrain.jpg";
import { useNavigate } from "react-router-dom";
import UserHeader from "../UserHeader";
import Footer from "../Footer";
import emailjs from "emailjs-com";

function Underterrain() {
      ...
      <div className="container">
        <div className="row mt-5">
          ...
          <div className="col-12 col-md-10 col-lg-6">
            <div className="mt-5">
              <h2>Urban Terrain Mountain Bike Shimano 5000</h2>
            </div>
            <p className="mb-5">Brand: Urban Terrain</p>
            <h3 className="mb-3">₹ 3,999</h3>
            <div className="mb-3">
            ...
            <ul>
              <li>
                The Shimano derailleurs and shifters are made with Japanese
                technology for a seamless gear shifting experience and
                trustworthy performance. The stylish bike has a 21 speed (7 X 3)
                setting that allows the rider to shift gears according to his
                requirement.
              </li>
              <li className="mt-1">
                Made from high quality steel frame these bikes are durably made
                to long last offering you excellent service life. Enjoy a quick
                ride to your work space, neighborhood rides, or trails on this
                Urban Terran 1000
              </li>
            </ul>
          </div>
              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">
                    {" "}
                    The mountain bike exceeded my expectations. Highly
                    recommended!
                  </p>
                </div>
              </div>
